            ...
            <div class="box-body">
             ...
             {{-- name --}}
                ...
                <div class="form-group col-sm-6" >
                    ...
                    <div class="col-sm-8">
                        <input type="text" autocomplete="off" class="form-control"  name="level" value="{{$students->first()->courses->last()->title}}"> 
                    </div>
                    <div class="col-sm-8">
                        <input type="hidden" autocomplete="off" class="form-control"  name="level_id" value="{{$students->first()->courses->last()->id}}"> 
                    </div>
                </div>
