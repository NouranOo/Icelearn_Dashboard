        ...
        <form class="form-horizontal" action="{{url('admin-panel/groups')}}" method="POST">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" autocomplete="off" class="form-control" placeholder="{{trans('courses::group.sessions')}}" name="sessions" required >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" name="groupStartDate" type="date" placeholder="{{trans('courses::group.groupStartDate')}}"
                        />
                    </div>
                </div>
